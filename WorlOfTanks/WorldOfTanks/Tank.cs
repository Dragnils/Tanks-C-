...
namespace WorlOfTanks.WorldOfTanks
{
   public class Tank
    {
        ...
        public Tank() { theNamesOfTheTank = null; levelTankAmmunition = 0; amorLevel = 0; levelManeuverability = 0; }

        public Tank(string nameoftank, int boekompl, int bron, int manev)
        {
